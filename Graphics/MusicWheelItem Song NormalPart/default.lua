...
local af = Def.ActorFrame{
	...
	Def.Quad{ InitCommand=function(self) self:horizalign(left):diffuse(0, 10/255, 17/255, 0.5):diffusealpha(0.8)
	...
	Def.Quad{ InitCommand=function(self) self:horizalign(left):diffuse(DarkUI() and {1,1,1,0.5}
		or {10/255, 20/255, 27/255, 1}):diffusealpha(0.8):zoomto(item_width, (_screen.h/num_visible_items)-1) end }
}
