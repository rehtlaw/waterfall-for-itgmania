...
t[#t+1] = LoadFont("raxye/_main")..{
	...
	GainFocusCommand=function(self) self:stoptweening():zoom(0.25):accelerate(0.1):diffuse(PlayerColor(PLAYER_2)):glow(1,1,1,0.5):decelerate(0.05):glow(1,1,1,0) end,
	LoseFocusCommand=function(self) self:stoptweening():zoom(0.2):accelerate(0.1):diffuse(color("#888888")):glow(1,1,1,0) end
}
